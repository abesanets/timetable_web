...
7. Откройте веб-приложение расписания, перейдите в **«Настройки»** -> **«CORS прокси-сервер»**, введите вашу ссылку в текстовое поле в формате:
   `https://cors-proxy-timetable.username.workers.dev/?url={url}`
